		...
		<table class="center content-table" id="myTable">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="update.php?id=<?php echo $s['id'];?>"><button class="edit">Edit</button></a>
						<a href="delete.php?id=<?php echo $s['id'];?>" onclick="return confirm('Do you want to delete?')"><button>Delete</button></a>
					</td>
